    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassCourse", x => x.lassCourseId);
                    table.ForeignKey(
                        name: "FK_ClassCourse_Class_Class",
                        column: x => x.Class,
                        principalTable: "Class",
                        principalColumn: "classId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassCourse_Course_Course",
                        column: x => x.Course,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassTest", x => x.classTestId);
                    table.ForeignKey(
                        name: "FK_ClassTest_Class_Class",
                        column: x => x.Class,
                        principalTable: "Class",
                        principalColumn: "classId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassTest_Test_Test",
                        column: x => x.Test,
                        principalTable: "Test",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Student_Test_ClassTest_Class_Test",
                        column: x => x.Class_Test,
                        principalTable: "ClassTest",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassCourse_Class",
                table: "ClassCourse",
                column: "Class");

            migrationBuilder.CreateIndex(
                name: "IX_ClassCourse_Course",
                table: "ClassCourse",
                column: "Course");

            migrationBuilder.CreateIndex(
                name: "IX_ClassTest_Class",
                table: "ClassTest",
                column: "Class");

            migrationBuilder.CreateIndex(
                name: "IX_ClassTest_Test",
                table: "ClassTest",
                column: "Test");
