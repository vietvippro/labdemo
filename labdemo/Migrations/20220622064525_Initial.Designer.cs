...
namespace labdemo.Migrations
{
    ...
    [Migration("20220622064525_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("labdemo.Entity.Admin", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.AdminAccount", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.Class", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.Class_Course", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.Class_Test", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.Course", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.Document", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.Grade", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.LearningOutcome", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("labdemo.Entity.Position", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.Student", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.Student_Test", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.StudentAccount", b =>
                {
                    b.Property<string>("userName")
                        .HasMaxLength(50)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("labdemo.Entity.Subject", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.Test", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.TestCategory", b =>
                {
            ...
            modelBuilder.Entity("labdemo.Entity.Admin", b =>
                {
                    b.HasOne("labdemo.Entity.Position", "Position1")
                        .WithMany("Admins")
                        .HasForeignKey("Position");

                    b.HasOne("labdemo.Entity.Subject", "Subject1")
                        .WithMany("Admins")
            ...
            modelBuilder.Entity("labdemo.Entity.AdminAccount", b =>
                {
                    b.HasOne("labdemo.Entity.Admin", "Admin1")
            ...
            modelBuilder.Entity("labdemo.Entity.Class", b =>
                {
                    b.HasOne("labdemo.Entity.Grade", "Grade1")
                        .WithMany("Classes")
                        .HasForeignKey("Grade");
            ...
            modelBuilder.Entity("labdemo.Entity.Class_Course", b =>
                {
                    b.HasOne("labdemo.Entity.Class", "Class1")
                        .WithMany("Class_Course")
                        .HasForeignKey("Class")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("labdemo.Entity.Course", "Course1")
                        .WithMany("Class_Course")
            ...
            modelBuilder.Entity("labdemo.Entity.Class_Test", b =>
                {
                    ...
                    b.HasOne("labdemo.Entity.Test", "Test1")
                        .WithMany("Class_Test")
                        .HasForeignKey("Test");
            ...
            modelBuilder.Entity("labdemo.Entity.LearningOutcome", b =>
                {
                    b.HasOne("labdemo.Entity.Student", "Student1")
                        .WithMany("LearningOutcomes")
                        .HasForeignKey("Student")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("labdemo.Entity.Student_Test", "Student_Test1")
                        .WithMany("LearningOutcomes")
            ...
            modelBuilder.Entity("labdemo.Entity.Student_Test", b =>
                {
                    b.HasOne("labdemo.Entity.Class_Test", "Class_Test1")
            ...
            modelBuilder.Entity("labdemo.Entity.Test", b =>
                {
                    b.HasOne("labdemo.Entity.TestCategory", "TestCategory1")
                        .WithMany("Tests")
